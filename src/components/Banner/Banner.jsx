...
const Banner = ({ freeCoins, handleFreeCoins }) => {
    return (
        <section className="px-2">
            <div className="bg-black max-w-300 mx-auto rounded-2xl overflow-hidden my-10">
                <div className="py-5 bg-cover bg-center min-h-96 flex flex-col text-white text-center justify-center items-center gap-5" style={{ backgroundImage: `url(${bannerBg})` }}>
                    <div>
